static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_BATTLE_FRONTIER_OUTSIDE_EAST - 1] = {MAP_GROUP(BATTLE_FRONTIER_OUTSIDE_EAST), MAP_NUM(BATTLE_FRONTIER_OUTSIDE_EAST), 3, 52},
        [HEAL_LOCATION_KNOT_ISLAND_MAIN - 1] = {MAP_GROUP(KNOT_ISLAND_MAIN), MAP_NUM(KNOT_ISLAND_MAIN), 14, 6},
    [HEAL_LOCATION_BOON_ISLAND_MAIN - 1] = {MAP_GROUP(BOON_ISLAND_MAIN), MAP_NUM(BOON_ISLAND_MAIN), 20, 8},
    [HEAL_LOCATION_KIN_ISLAND_MAIN - 1] = {MAP_GROUP(KIN_ISLAND_MAIN), MAP_NUM(KIN_ISLAND_MAIN), 14, 27},
    [HEAL_LOCATION_FLOE_ISLAND_MAIN - 1] = {MAP_GROUP(FLOE_ISLAND_MAIN), MAP_NUM(FLOE_ISLAND_MAIN), 18, 21},
    [HEAL_LOCATION_CHRONO_ISLAND_MAIN - 1] = {MAP_GROUP(CHRONO_ISLAND_MAIN), MAP_NUM(CHRONO_ISLAND_MAIN), 17, 7},
    [HEAL_LOCATION_FORTUNE_ISLAND_MAIN - 1] = {MAP_GROUP(FORTUNE_ISLAND_MAIN), MAP_NUM(FORTUNE_ISLAND_MAIN), 17, 7},
    [HEAL_LOCATION_QUEST_ISLAND_MAIN - 1] = {MAP_GROUP(QUEST_ISLAND_MAIN), MAP_NUM(QUEST_ISLAND_MAIN), 11, 4},
};
