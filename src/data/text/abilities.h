...
static const u8 sSlushRushDescription[] = _("Raises Speed in Hail/Snow.");
...
static const u8 sSolidRockDescription[] = _("");
...
static const u8 sArmorTailDescription[] = _("");
static const u8 sMindsEyeDescription[] = _("");
